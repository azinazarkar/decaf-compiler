...
public class GreaterEqualCodeGen {
    private static GreaterEqualCodeGen instance = new GreaterEqualCodeGen();
    public static GreaterEqualCodeGen getInstance(){return instance;}
    private GreaterEqualCodeGen(){}
    public void cgen(){
        ...
        if (d1.getType() == Type.INT){
            ...
            CodeGen.getInstance().addToText("sge $t0, $a0, $a1");
